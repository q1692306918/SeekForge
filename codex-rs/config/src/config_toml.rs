...
pub struct ConfigToml {
    ...
    /// DeepSeek-native fork settings. Defaults are conservative so the
    /// planner does not change execution behavior until explicitly enabled.
    #[serde(default)]
    pub deepseek_native: Option<DeepSeekNativeToml>,
