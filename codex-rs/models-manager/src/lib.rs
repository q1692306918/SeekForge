...
const DEEPSEEK_CONTEXT_WINDOW: i64 = 1_000_000;
const DEEPSEEK_AUTO_COMPACT_TOKEN_LIMIT: i64 = 900_000;
...
fn deepseek_model(
    ...
    ModelInfo {
        ...
        auto_compact_token_limit: Some(DEEPSEEK_AUTO_COMPACT_TOKEN_LIMIT),
